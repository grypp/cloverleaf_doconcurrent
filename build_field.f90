...
SUBROUTINE build_field()
  ...
  DO tile=1, tiles_per_chunk
    ...
    DO CONCURRENT(k=chunk%tiles(tile)%t_ymin-2:chunk%tiles(tile)%t_ymax+3, &
        j=chunk%tiles(tile)%t_xmin-2:chunk%tiles(tile)%t_xmax+3)
    ...
    DO CONCURRENT(k=chunk%tiles(tile)%t_ymin-2:chunk%tiles(tile)%t_ymax+2, &
                  j=chunk%tiles(tile)%t_xmin-2:chunk%tiles(tile)%t_xmax+2)
    ...
    DO CONCURRENT(j=chunk%tiles(tile)%t_xmin-2:chunk%tiles(tile)%t_xmax+2)
    ...
    DO CONCURRENT(j=chunk%tiles(tile)%t_xmin-2:chunk%tiles(tile)%t_xmax+3)
